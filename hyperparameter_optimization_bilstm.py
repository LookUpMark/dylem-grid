...
from src.bilstm_model import GestureRNN, train_model, evaluate_model
...
def main():
    ...
    data, labels = data_loader('DYLEM-GRID', 'Cleaned')
    ...
    if len(best_trials_at_max_acc) > 1:
        ...
        print(f"Selected trial {best_trial.number} with fewest parameters ({best_trial.user_attrs.get('num_params', 'N/A'):,}).")
    ...
    try:
        ...
        fig.write_image('plots_output/optuna_optimization_history.png')
        print("Optimization history saved")
        
        # 2. Parameter importances
        fig = plot_param_importances(study)
        fig.write_image('plots_output/optuna_param_importances.png')
        print("Parameter importances saved")
        
        # 3. Parallel coordinate plot
        fig = plot_parallel_coordinate(study)
        fig.write_image('plots_output/optuna_parallel_coordinate.png')
        print("Parallel coordinate plot saved")
        
        # 4. Slice plot
        fig = plot_slice(study)
        fig.write_image('plots_output/optuna_slice.png')
        ...
        print("Results are saved in 'optuna_results.json' and 'optuna_study.pkl'")
        print("You can view results using: optuna-dashboard optuna_study.pkl")
    ...
    print("\n" * 2)
    print("Next Steps:")
    print("  1. Update train_bilstm.py with best hyperparameters")
    print("  2. Train final model on full training set")
    print("  3. Evaluate on test set")
    print("\n" * 2)
    print("Advanced:")
    print("  View interactive dashboard: optuna-dashboard optuna_study.pkl")
    print("  Load study: study = joblib.load('optuna_study.pkl')")
    print()
